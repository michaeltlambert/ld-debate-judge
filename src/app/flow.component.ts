          ...
          <div *ngFor="let col of columns; let i = index" 
            ...
            <div class="flex-1 p-2 space-y-3 overflow-y-auto min-h-[400px]">
              ...
              <div *ngFor="let arg of getArgsForCol(i)" 
                   ...
                   [ngClass]="{
                     'bg-purple-50 border-purple-300 ring-1 ring-purple-200 shadow-md': arg.isVoter,
                     'bg-green-50 border-green-200 opacity-70': !arg.isVoter && arg.status === 'addressed',
                     'bg-red-50 border-red-200': !arg.isVoter && arg.status === 'dropped',
...
// UPDATED: Full descriptive names for new judges
  ...
  frameworks = signal<Record<string, FrameworkData>>({
    '1AC': { value: '', criterion: '' },
    '1NC': { value: '', criterion: '' }
  });
