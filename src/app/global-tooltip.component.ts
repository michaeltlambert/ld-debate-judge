...
@Component({
  ...
  template: `
    <div *ngIf="svc.isVisible()"
         ...
         style="transform: translateX(-50%);"> <div class="bg-slate-900 text-white text-xs p-3 rounded-lg shadow-2xl border border-slate-700 w-48 relative animate-in fade-in zoom-in-95 duration-100">
